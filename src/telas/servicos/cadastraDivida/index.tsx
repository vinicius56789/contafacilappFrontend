...
export default function CadastraDivida() {

    const navigation = useNavigation<propsStack>();
    const params = useRoute<RouteProp<propsNavigationStack, "cadastraDivida">>()
    ...
    const cadastro = async () => {
        await axios.post('http://192.168.1.2:8085/contafacilapp/debt/insert', {
    ...
    return(
        <KeyboardAvoidingView style={styles.backgroundTela}>
                ...
                <View style={styles.containerCorpo}>
                    ...
                    <Text style={styles.login}>CADASTRO DE DÍVIDA</Text>
