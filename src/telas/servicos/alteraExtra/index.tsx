...
export default function AlteraExtra() {

    const navigation = useNavigation<propsStack>();
    const params = useRoute<RouteProp<propsNavigationStack, "alteraExtra">>()
    ...
    const altera = async () => {
        await axios.post('http://192.168.1.2:8085/contafacilapp/extraIncome/update', {
    ...
    return(
        <KeyboardAvoidingView style={styles.backgroundTela}>
                ...
                <View style={styles.containerCorpo}>
                    ...
                    <Text style={styles.login}>ATUALIZAR RENDA EXTRA</Text>
